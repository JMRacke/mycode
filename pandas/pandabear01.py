...
def main():
    ...
    # DF has 5 rows and 24 columns (index by title)
    ...
    # Combines all DFs into a single DF called movies
    movies = pd.concat([movies_sheet1,movies_sheet2,movies_sheet3])

    # number rows and columns (5042,24)
    print(movies.shape)

    # sort DF based on gross earnings
