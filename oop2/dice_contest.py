#!/usr/bin/python3
"""RZFeese | Alta3 Research"""

from cheatdice import * # imports all everything from cheatdice (this may cause an error cause I'll have another main()) UPDATE: Nah it's good
